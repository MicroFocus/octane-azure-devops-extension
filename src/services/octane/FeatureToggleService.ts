...
export class FeatureToggleService {
    ...
    public static async getInstance(tl, logger: LogUtils, sharedSpaceId: string, workspaceId: string) : Promise<FeatureToggleService> {
        let featureToggleService = new FeatureToggleService(tl, logger);
        await featureToggleService.init(sharedSpaceId, workspaceId);
        return featureToggleService;
    }

    protected async init(sharedSpaceId: string, workspaceId: string) {
    ...
    public async getUseAzureDevopsParametersOctaneParameter(octaneSDKConnection): Promise<boolean>{
