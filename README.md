...
2. Configure the `testsToRun` Conversion. To run the selected tests, configure a job or step to convert the testsToRun value into the format required by your test framework. This logic should be handled in your test automation setup. For reference: @opentext/sdp-sdm-tests-to-run-conversion
